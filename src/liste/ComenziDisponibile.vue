<template>
    ...
    <div class="container" style="padding: 10px">
        ...
        <navbar><h2>Comenzi disponibile</h2><router-link class="btn btn-primary" style="font-size: medium" router-link  to="/comenzi_azi">Inapoi la comenzi</router-link></navbar
